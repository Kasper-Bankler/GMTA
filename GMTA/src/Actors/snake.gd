...
onready var audioPlayerSnake = $AudioStreamSnake
export var timerTime = 3
export var this_health=3

export var scaleVis = 2.0
...
func _on_AudioStreamSnake_finished():
	if isChasing:
		audioPlayerSnake.play()
